...
export class OwnerController {
  ...
  deleteTool(@Param('id', ParseIntPipe) id: number) {
    return this.ownerService.deleteTool(id);
  }
  ...
  // OWNER ORDERS
  //URL: http://localhost:7000/owner/orders/:ownerid
  @UseGuards(OwnerAuthGuard)
  @Get('orders/:ownerid')
  ...
  // APPROVE ORDER
  //URL: http://localhost:7000/owner/orders/:orderid/approve
  @UseGuards(OwnerAuthGuard)
  ...
  // REJECT ORDER
  //URL: http://localhost:7000/owner/orders/:orderid/reject
  @UseGuards(OwnerAuthGuard)
